...
TASKS_5DIGIT_JSON = DATA_DIR / "tasks_5digit.json"
CHALLENGE_TASKS_JSON = DATA_DIR / "challenge_tasks.json"
COMPLETE_JSON = DATA_DIR / "complete.json"
...
TD_EXPERIMENTS_MD = LOGS_DIR / "tdExperiments.md"
OS_EXPERIMENTS_MD = LOGS_DIR / "opensubtitlesExperiments.md"
WIKI_EXPERIMENTS_MD = LOGS_DIR / "wikiExperiments.md"
TS_EXPERIMENTS_MD = LOGS_DIR / "tinystoriesExperiments.md"
...
BABYLM_SFT_ALLTASKS_EVALS_MD = BABYLM_FINETUNE_LOGS_DIR / "babylm_sft_alltasks_evals.md"
CHILDES_SFT_ALL_EVALS_MD = BABYLM_FINETUNE_LOGS_DIR / "childes_sft_evals.md"
TD_SFT_ALL_EVALS_MD = BABYLM_FINETUNE_LOGS_DIR / "td_sft_evals.md"
OS_SFT_ALL_EVALS_MD = BABYLM_FINETUNE_LOGS_DIR / "os_sft_evals.md"
WIKI_SFT_ALL_EVALS_MD = BABYLM_FINETUNE_LOGS_DIR / "wiki_sft_evals.md"
TS_SFT_ALL_EVALS_MD = BABYLM_FINETUNE_LOGS_DIR / "ts_sft_evals.md"
MINIBERTA_SFT_ALL_EVALS_MD = BABYLM_FINETUNE_LOGS_DIR / "miniberta_sft_evals.md"
